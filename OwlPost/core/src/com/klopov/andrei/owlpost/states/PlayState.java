...
import com.klopov.andrei.owlpost.sprites.Bird;
import com.klopov.andrei.owlpost.sprites.Tube;

public class PlayState extends State {

    public static final int TUBE_SPACING = 230;
    ...
    public PlayState(GameStatManager gsm) {
        super(gsm);
